...
vehIFV = 			["rhs_sprut_vdv","rhs_bmd2m","rhs_bmd4m_vdv","rhs_bmp2d_msv","rhs_bmp3m_msv"]; // IFVs
vehTank = 			["rhs_t14_tv","rhs_t90saa_tv","rhs_t90a_tv","rhs_t72be_tv","rhs_t90am_tv"]; // MBTs
...
heli_armed = 		["RHS_Ka52_vvsc","rhsgref_mi24g_CAS"]; // // armed helicopters
